public static class MauiExceptions
{
    ...
    public static MauiAppBuilder UseGlobalExceptionHandler(this MauiAppBuilder builder, UnhandledExceptionEventHandler? onExceptionCaught = null)
    {
        UnhandledException += onExceptionCaught;
